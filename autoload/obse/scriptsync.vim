...
if !exists("g:ov_obse#scriptsync#ShowFloatLog")
  let g:ov_obse#scriptsync#ShowFloatLog = '<C-a>l'
endif
execute 'nnoremap <buffer> ' . g:ov_obse#scriptsync#ShowFloatLog . " :call OV_Main(2)<CR>"
" }}}

" autogroup from disable support {{{
